Peak Current Mode Control Peripheral Configuration Example
==========================================================
...
This code example establishes a peak current mode feedback loop. Potentiometers P1 and P2 are used
to set the DAC reference level and to emulate the current feedback signal. The DAC slope generator
is continuously modulating the slew rate, starting at 100mV/usec increasing the slope up to ~1V/usec
and resetting to 100mV/usec.
